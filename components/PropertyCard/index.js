...
const PropertyCard = ({ product }) => {
  return (
    <div class="relative bg-white rounded-2xl shadow-xl sm:max-w-[18rem] max-w-none">
      <div class="">
      ...
      <div class="py-2 px-4">
        <p class="font-semibold text-gray-800 text-xl">$ {numberWithCommas(product?.price)}</p>
